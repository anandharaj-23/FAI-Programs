...
path = a_star_search(start_node, goal_state, manhattan_heuristic)
if path:
...
print("Greedy Best-First Search with Out-of-Sequence Heuristic:")
path = greedy_best_first_search(start_node, goal_state, out_of_sequence_heuristic)
if path:
    print("Solution found!")
    print(f"Moves: {path}")
else:
